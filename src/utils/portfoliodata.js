    ...
    highlights: {
        openAI: {
            ...
            images: [
                {
                    link: "#",
                    description: "I designed this chat interface to allow users to easily input words, showcasing the simplicity and user-friendliness of the application."
                },
                {
                    link: "#",
                    description: "This flashcard, generated by the OpenAI API, is an example of how I've provided comprehensive information for each word."
                }
            ],
            codeImages: [
                {
                    link: "https://github.com/louderthanme/WordFlash/blob/main/src/Pages/Chat/chat.component.jsx",
                    description: "In this snippet, I demonstrate the logic I implemented in the chat component for handling user inputs and API interactions."
                },
                {
                    link: "https://github.com/louderthanme/WordFlash/blob/main/backend/index.js",
                    description: "Here, I show the backend setup for the OpenAI API integration, highlighting how I process and send user queries to the API."
                }
            ],
