        ...
        <Box>
            <Grid container justifyContent="center" alignItems="center">
                <Grid item xs={12} sm={12} md={12} align="center">
                    ...
                    <StyledTypography variant={ isMobile ? 'h4': 'h3'}  textAlign={'center !important'}>
                        Ruben Aguirre
                    </StyledTypography>
                    <StyledTypography variant="h6" fontStyle={"italic"} paddingBottom={3} textAlign={'center !important'}>
